...
const Navbar = () => {
    const { setShowLogin, navigate, user, backendUrl, setUser, isAdmin, setIsAdmin, filterUserSavedBlogs, setIsAuth, isAuth } = useContext(AppContext);
                ...
                user && (
                    <div className='flex items-center gap-5'>
                        ...
                        <div className='relative'>
                            <img src={user?.image} alt="user_image" onClick={() => setShowOptions(!showOptions)} className='w-10 h-10 object-cover rounded-full cursor-pointer' />
                            {
                                showOptions && (
                                    <motion.div 
                                    initial={{opacity:0}}
                                    ...
                                    className='absolute top-10 items-start right-6  flex flex-col w-36 bg-violet-100 p-1.5 rounded-ss-xl rounded-ee-xl rounded-es-xl z-20 '>
                                        {
